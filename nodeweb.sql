...
INSERT INTO `jobs` VALUES (1,'hhhjjkkllllllll','[\"tag1\",\"tag2\",\"tag3\",\"tag4\",\"tag5\"]','[\"name1\",\"name2\",\"name3\",\"name4\",\"name5\"]','localhost:8080/img/0.8398825221737951_webJoinus_03.png',1,1462685635,1462688462,'',''),(3,'hhhjj','[\"tag5\",\"tag4\",\"tag3\",\"tag2\",\"tag1\"]','[\"name5\",\"name4\",\"name3\",\"name2\",\"name1\"]','localhost:8080/img/0.9719382761686346_webJoinus_03.png',1,1462687174,0,'',''),(4,'hhhjjkk','[\"tag1\",\"tag2\",\"tag3\",\"tag4\",\"tag5\"]','[\"name1\",\"name2\",\"name3\",\"name4\",\"name5\"]','localhost:8080/img/0.9627047663493027_webJoinus_03.png',0,1462687482,0,'',''),(5,'hhhjjkklll','[\"tag1\",\"tag2\",\"tag3\",\"tag4\",\"tag5\"]','[\"tag1\",\"tag2\",\"tag3\",\"tag4\"]','',1,1462687528,1462852167,'',''),(6,'testt','[\"kk\"]','[\"kk\"]','',1,1462848828,1462849721,'',''),(7,'test11','[\"hh\",\"jj\",\"kk\",\"ll\",\"ff\"]','[\"hh\",\"jj\",\"kk\"]','',0,1462849371,0,'',''),(8,'jjj','[\"kkk\",\"ddd\"]','[\"ddd\",\"lll\",\"hhh\"]','',1,1462852194,1462853062,'',''),(9,'dfdddd','[\"ddd\",\"l\"]','[\"l\",\"dd\"]','',1,1462852318,0,'',''),(10,'gdfg','[\"ddd\",\"vv\"]','[\"vvv\",\"dd\",\"lll\"]','',1,1462852365,1462853072,'','');
...
INSERT INTO `users` VALUES (1,'kk','c089feab324d1fee612fdb1291412d03','xUcHbUFqb0SnW9uG',0,1462775417,1462777141,'','');
...
-- Dump completed on 2016-05-10 12:33:27
